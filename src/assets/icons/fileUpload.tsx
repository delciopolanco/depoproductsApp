export const FileUploadIcon = () => {
	return (
		...
		>
			...
			<path
				d={
					'M650,694.81c0-51.76,51.11-99.48,102.87-99.48,7.93,0,15.62-2,23-.16.1-2.26.16-15.54.16-17.82V51.81H328l-92,94.5v611.5H659C649.9,743.37,650,713.15,650,694.81Z'
				}
			...
			<path
				d={
					'M642,704.81a117,117,0,0,1,117-117c3.53,0,7,.17,10.48.47V317h-525V745.81H649.39A116.74,116.74,0,0,1,642,704.81Z'
				}
				transform={'translate(-236 -51.81)'}
				fill={'#fcfcfc'}
			/>
			...
			<g opacity={'0.5'}>
				<polygon
					points={
						'678.44 684.95 639.16 684.95 639.16 645.68 616.58 645.68 616.58 684.95 577.3 684.95 577.3 707.54 616.58 707.54 616.58 746.82 639.16 746.82 639.16 707.54 678.44 707.54 678.44 684.95'
					}
			...
			<path
				d={
					'M755,739.81c0-51.76,51.11-99.48,102.87-99.48,7.93,0,15.62-2,23-.16.1-2.26.16-15.54.16-17.82V96.81H433l-92,94.5v611.5H764C754.9,788.37,755,758.15,755,739.81Z'
				}
				transform={'translate(-236 -51.81)'}
			...
			<path
				d={
					'M747,749.81a117,117,0,0,1,117-117c3.53,0,7,.17,10.48.47V362h-525V790.81H754.39A116.74,116.74,0,0,1,747,749.81Z'
				}
				transform={'translate(-236 -51.81)'}
				fill={'#fff'}
			/>
